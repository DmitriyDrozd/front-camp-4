...
var nonIterableSpread = __webpack_require__(337);
...
// CONCATENATED MODULE: ./src/config/Endpoint.js
var API_KEY = 'apiKey=b9d575a774ac4011b9a10a7584c32ce1';
var ENDPOINT = 'https://newsapi.org/v2/';
var SOURCES = "".concat(ENDPOINT, "sources?");
var NEWS = "".concat(ENDPOINT, "everything?");
...
var asyncToGenerator = __webpack_require__(93);
...
var toConsumableArray = __webpack_require__(94);
var toConsumableArray_default = /*#__PURE__*/__webpack_require__.n(toConsumableArray);

// CONCATENATED MODULE: ./src/services/newsLetter/index.js
...
var newsLetter_NewsLetter =
/*#__PURE__*/
function () {
  function NewsLetter(apiKey) {
    classCallCheck_default()(this, NewsLetter);

    this._apiKey = apiKey;
    this._news = {};
  }

  createClass_default()(NewsLetter, [{
    key: "getOptions",
    value: function getOptions() {
      var _this = this;

      var sources = "".concat(SOURCES).concat(this._apiKey);
      return fetch(sources).then(function (sourcesList) {
        return sourcesList.json();
      }).then(function (res) {
        _this.options = res.sources;
        return toConsumableArray_default()(_this.options);
      });
    }
  }, {
    key: "getNews",
    value: function getNews(source) {
      ...
      var count = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_COUNT;

      if (source) {
        var news = "".concat(NEWS, "sources=").concat(source, "&pageSize=").concat(count, "&").concat(this._apiKey);
        var cached = this._news[source];

        if (cached && cached.length === count) {
          return cached;
        }

        return fetch(news).then(function (res) {
          return res.json();
        }).then(function (res) {
          _this2._news[source] = res.articles;
          return toConsumableArray_default()(_this2._news[source]);
        });
      }
    }
  }]);
...
/* harmony default export */ var Option = (getOptionElement);
// CONCATENATED MODULE: ./src/components/CategorySelect/index.js


var CategorySelect_fillSelectElement = function fillSelectElement(selectEl, options) {
...
/* harmony default export */ var CategorySelect = (CategorySelect_fillSelectElement);
// CONCATENATED MODULE: ./src/components/NewsList/index.js



var getPost = function getPost(article) {
  var li = document.createElement('li');
  var colorClass = Math.floor(Math.random() * 4) + 1;
  var img = article.urlToImage ? "<img src=\"".concat(article.urlToImage, "\" alt=\"Image for ").concat(article.title, "\" class=\"item-image\">") : '';
  var linkStart = "<a href=".concat(article.url, " target=\"_blank\">");
  var linkEnd = "</a>";
  var content = '';

  if (img.length > 0) {
    content = "<div class=\"item-content with-image\">".concat(linkStart).concat(img).concat(article.title).concat(linkEnd, "</div>");
  } else {
    var description = article.description || article.content;
    content = "<div class=\"item-content\">".concat(linkStart).concat(article.title).concat(linkEnd, "\n                <p class=\"description\">").concat(description, "</p>\n            </div>");
  }

  li.className = "news-list-item color-".concat(colorClass);
  li.innerHTML = content;
  return li;
};

var NewsList_NewsList =
/*#__PURE__*/
function () {
  function NewsList() {
    classCallCheck_default()(this, NewsList);

    this.container = document.getElementById('newsList');
    this.news = [];
  }

  createClass_default()(NewsList, [{
    key: "add",
    value: function add(news) {
      ...
      try {
        for (var _iterator = news[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var article = _step.value;
          var li = getPost(article);
...
function () {
  function Spinner(id) {
    ...
    this.spinner.id = id;
    var dots = Array(DOTS_COUNT).fill(0).map(function () {
      return document.createElement('div');
    });
    dots.forEach(function (dot) {
      _this.spinner.appendChild(dot);
    });
  }
  ...
  createClass_default()(Spinner, [{
    ...
    value: function start() {
      ...
      element.childNodes.forEach(function (child) {
        child.classList && child.classList.add(HIDE_CLASS);
      });
    ...
    value: function stop() {
      ...
      this.spinner.remove();
      element.childNodes.forEach(function (child) {
        child.classList && child.classList.remove(HIDE_CLASS);
      });
    }
  }]);
...
function () {
  function App(apiKey) {
    ...
    this._newsList = new NewsList_NewsList();
  ...
  createClass_default()(App, [{
    ...
    value: function addEventListeners() {
      ...
      this.selectElement.addEventListener('change', function (e) {
        return _this.loadNews(e.target.value);
      });
    }
  }, {
    key: "init",
    value: function () {
      ...
      regenerator_default.a.mark(function _callee() {
        var navId, spinner, options;
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                navId = this.navigationElement.id;
                spinner = new Spinner_Spinner(navId);
                spinner.start();
                _context.next = 5;
                return this._newsLetterService.getOptions();

              case 5:
                options = _context.sent;
                spinner.stop();
                CategorySelect(this.selectElement, options);
    ...
    key: "loadNews",
    value: function () {
      var _loadNews = asyncToGenerator_default()(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee2(source) {
        var spinner, news;
        return regenerator_default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                spinner = new Spinner_Spinner(this._newsList.id);

                this._newsList.clear();

                spinner.start();
                _context2.next = 7;
                return this._newsLetterService.getNews(source);
...
var element_remove = __webpack_require__(338);
...
var src_onLoad = function onLoad() {
  var app = new components_App(API_KEY);
  app.init();
};

document.addEventListener('DOMContentLoaded', src_onLoad);
